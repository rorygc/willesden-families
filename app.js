...
const DATA = {
  thisWeek: [
    ...
    {
      id: 'week-booktrust-rhymetime',
      section: 'this-week',
      name: 'BookTrust under 5s story and rhymetimes',
      age: '0–5',
      cost: 'free',
      area: 'Willesden Green',
      blurb: 'Free story and rhymetime sessions for babies, toddlers, and carers at the library.',
      recommendation: 'Good default if you want a calm indoor session with a proper early-years focus.',
      tags: ['library', 'story time', 'free'],
      contact: 'https://www.brent.gov.uk/libraries-arts-and-heritage/libraries/library-events/under-5s-wg',
      linkLabel: 'See event',
    ...
    },
    {
      id: 'week-stem-club',
      section: 'this-week',
      name: 'Ealing Road Library STEM club',
      age: '8–11',
      cost: 'free',
      area: 'Ealing Road',
      blurb: 'Interactive STEM workshops for curious children who like making and experimenting.',
      recommendation: 'Useful if your child wants a more hands-on library activity.',
      tags: ['STEM', 'library', 'free'],
      contact: 'https://www.brent.gov.uk/libraries-arts-and-heritage/libraries/library-events/stem-club-2025-and-early-26',
      linkLabel: 'See STEM club',
      mapQuery: 'Ealing Road Library, Brent, London',
      featured: false,
      cardTone: 'weekly'
    },
    {
      id: 'week-international-childrens-day',
      section: 'this-week',
      name: "International Children's Day event",
      age: 'all ages',
      cost: 'free',
      area: 'Willesden Green',
      blurb: 'A bigger family event at the library with activities and a clear child-friendly focus.',
      recommendation: 'Worth watching if you want a one-off free family outing.',
      tags: ['family event', 'library', 'free'],
    ...
    {
      id: 'week-empathy-day-festival',
      section: 'this-week',
      name: 'Empathy Day Festival',
      age: 'all ages',
      cost: 'free',
      area: 'Willesden Green',
      blurb: 'Storytelling, crafts, face painting, and family activities at The Library at Willesden Green.',
      recommendation: 'Good if you want something broader than a standard story session.',
      tags: ['festival', 'library', 'free'],
      contact: 'https://www.brent.gov.uk/libraries-arts-and-heritage/libraries/library-events/empathy-day-festival-6--june-wg',
      linkLabel: 'See festival',
      mapQuery: 'The Library at Willesden Green, London',
      featured: false,
      cardTone: 'weekly'
    },
  ...
  camps: [
    ...
    },
    {
      ...
      blurb: 'May half-term tennis camps at Elmwood with Daniele and Will, plus daily and weekly booking options.',
