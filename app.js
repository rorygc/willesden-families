...
const DATA = {
  thisWeek: [
    {
      ...
      eventDate: '1 Jul–5 Sep',
      eventTime: 'see page',
      blurb: 'Brent Libraries’ summer programme mixes reading challenges with weekly themes like adventure, STEM, sport, storytelling, arts and crafts.',
      recommendation: 'A big easy win for rainy days — and a good excuse to visit local libraries all summer.',
      tags: ['library', 'summer', 'reading', 'craft', 'indoor', 'free'],
      contact: 'https://www.brent.gov.uk/summer-in-brent/summer-fun-festival-2026',
      linkLabel: 'Summer festival page',
      mapQuery: 'The Library at Willesden Green, 95 High Road, London NW10 2SF',
      featured: true,
      cardTone: 'weekly'
    },
    {
  ...
  activities: [
    ...
    {
      id: 'act-kilburn-cosmos-juniors',
      section: 'activities',
      name: 'Kilburn Cosmos RFC Juniors',
      age: '5+',
      cost: 'mid',
      area: 'Kilburn / Gladstone Park',
      blurb: 'Local junior rugby at Gladstone Park with sessions starting from age 5. A friendly option if you want a proper club setup and an active team sport close to home.',
      recommendation: 'Great for rugby-mad kids — the juniors section starts young and keeps things local.',
